...
//		self.backgroundColor = [UIColor colorWithRed:226.0/255.0 green:231.0/255.0 blue:237.0/255.0 alpha:1.0];
		...
		UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, RefreshViewHight - 30.0f, Screen_Width, 20.0f)];
		...
		label = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, RefreshViewHight - 48.0f, Screen_Width, 20.0f)];
		label.autoresizingMask = UIViewAutoresizingFlexibleWidth;
...
- (void)setState:(EGOPullRefreshState)aState{
	...
	switch (aState) {
		...
		case EGOOPullRefreshNormal:
			...
			_statusLabel.text = NSLocalizedString(@"上提更多...", @"上提更多...");
